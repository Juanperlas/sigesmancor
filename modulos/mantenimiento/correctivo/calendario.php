...
$titulo = "Calendario de Mantenimientos Correctivos | SIGESMANCOR";
...
$css_adicional = [
    'assets/css/mantenimiento/correctivo/calendario.css',
];

// Incluir JS adicional
$js_adicional = [
    'assets/js/vendor/fullcalendar/index.global.min.js',
    'assets/js/mantenimiento/correctivo/calendario.js'
];
    ...
    <div class="container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h1 class="page-title">Calendario de Mantenimientos Correctivos</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo getPageUrl('dashboard.php'); ?>">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="<?php echo getPageUrl('modulos/mantenimiento/correctivo/index.php'); ?>">Mantenimiento Correctivo</a></li>
                ...
                <div class="col-auto">
                    <div class="page-actions">
                        <a href="<?php echo getPageUrl('modulos/mantenimiento/correctivo/index.php'); ?>" class="btn btn-outline-secondary">
                            <i class="bi bi-arrow-left me-1"></i> Volver
                        </a>
                        <button id="refreshCalendar" class="btn btn-primary" onclick="location.reload();">
        ...
        <div class="calendario-layout">
            ...
            <div class="calendario-container">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="correctiveMaintenanceCalendar"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="mantenimientos-panel">
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-sm table-hover" id="mantenimientosPendientesTable">
                                <thead>
                                    <tr>
                                        <th>Código</th>
                                        <th>Equipo/Componente</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="maintenanceDetailsModalLabel">Detalles del Mantenimiento Correctivo</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="maintenance-details">
                    <div class="row mb-3">
                        <div class="col-4 fw-bold">Equipo/Componente:</div>
                    ...
                    <div class="row mb-3">
                        <div class="col-4 fw-bold">Fecha Problema:</div>
                        <div class="col-8" id="modalFechaProblema"></div>
                    </div>
